...
# === Konfiguration ===
PARAM_DIR = "model_training/xgb_physics"
PARAM_FILES = {
    "baseline": "tuned/xgb_physics_baseline_params.json",
    "tuned_v1": "tuned/xgb_bias_tuned_v1_params.json"
}
...
X, y_true = get_features_and_target(full_df)
y_physical = full_df["F_pull_physical"]
y = y_true - y_physical  # Der Bias ist die Zielgröße
...
plt.title(f"Comparison of XGBoost Bias Models – {metric_to_plot}")
plt.grid(True, axis="y", linestyle="--", alpha=0.7)
plt.tight_layout()

# === Grafik speichern ===
plot_path = os.path.join(PARAM_DIR, f"xgb_bias_cv_comparison_{metric_to_plot.lower()}.png")
