...
# === Konfiguration ===
PARAM_DIR = "model_training/decision_tree"
PARAM_FILES = {
    "baseline": "tuned/dt_model_baseline_params.json",
    "tuned_v1": "tuned/dt_model_tuned_v1_params.json",
    "tuned_v2": "tuned/dt_model_tuned_v2_params.json"
}
...
plt.title(f"Comparison of the Decision Tree Models ({metric_to_plot})")
plt.grid(True, axis="y", linestyle="--", alpha=0.7)
plt.tight_layout()

# === Grafik speichern ===
plot_path = os.path.join(PARAM_DIR, f"decision_tree_cv_comparison_{metric_to_plot.lower()}.png")
