...
# === Konfiguration ===
PARAM_DIR = "model_training/xgboost"
PARAM_FILES = {
    "baseline": "baseline/xgb_model_baseline_params.json",
    "tuned_v1": "tuned/xgb_model_tuned_v1_params.json",
    "tuned_v2": "tuned/xgb_model_tuned_v2_params.json",
    "tuned_v3": "tuned/xgb_model_tuned_v3_params.json",
    "tuned_v4": "tuned/xgb_model_tuned_v4_params.json",
    "tuned_v5": "tuned/xgb_model_tuned_v5_params.json",
    "tuned_v6": "tuned/xgb_model_tuned_v6_params.json"
}
...
plt.title(f"Comparison of the xgb_models {metric_to_plot}")
plt.grid(True, axis="y", linestyle="--", alpha=0.7)
plt.tight_layout()

# === Grafik speichern ===
plot_path = os.path.join("model_training", "xgboost", f"xgb_cv_comparison_{metric_to_plot.lower()}.png")
